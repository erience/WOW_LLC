                    ...
                    <div className="row gy-4 justify-content-between align-items-center">
                        ...
                        <div className="col-xl-7 col-lg-8 text-lg-end text-center">
                            <ul className="footer-menu-list">
                                ...
                                <li>
                                    <Link href="/#ecosystemSection">
                                        Eccosystem
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/#tokenomicsSection">
                                        Tokenomics
                                    </Link>
                                </li>
                                <li>
                ...
                <div className="container">
                    <div className="row gy-3 justify-content-between align-items-center">
                        <div className="col-lg-6 align-self-center">
                            <p className="copyright-text">&copy;  {currentYear}  All rights Reserved. By <Link href="#">WOW LLC.</Link></p>
                        </div>
                        <div className="col-lg-6 text-lg-end">
                            <ul className="footer-links">
                                <li>
                                    <Link href="" className="tool-tip">
